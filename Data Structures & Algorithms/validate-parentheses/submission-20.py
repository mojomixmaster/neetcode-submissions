class Solution:
    def isValid(self, s: str) -> bool:
        ...
        # what data structure can support this type of computation? (solution from neetcode vid after making my own soln: stack which is FIFO and implemented in python with list [])
        ...
        while pairs_to_match > 0:
            ...
            for i in range(len(s)):
                ...
                if s[i] in opening_bracket_types and i not in matched_pair_indices:
                    ...
                    break # we have found the first unmatched closed bracket. This MUST be the corresponding closed bracket for the last opening bracket type seen i.e. opening bracket on top of stack ELSE INVALID
            

            if idx_of_last_opening_bracket == -1 or idx_of_first_closing_bracket is None: return False # ensure we have found at least one of each opening and closing bracket type else INVALID
