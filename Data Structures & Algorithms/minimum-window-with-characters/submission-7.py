    ...
    def minWindow(self, s: str, t: str) -> str:
        ...
        while r < len(s):
            ...
            if s[r] in t: # if the counts for that specific char in t already satifisfied, ensure value never goes below zero
                ...
                # elif num_t_matches == 2:
                #     l = r # the place we will start our next candidate window will be from the 2nd t match ie the next char in t that is not currently starting char of window
                #     print(l)
