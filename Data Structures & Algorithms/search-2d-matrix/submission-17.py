class Solution:
    def searchMatrix(self, matrix: List[List[int]], target: int) -> bool:
        ...
        # we now know the rows window where target COULD be within, perform binary search within it to find the ONE row target can be within!
        l, r = left_edge_idx , right_edge_idx
        while l < r:
