class Solution:
    def searchMatrix(self, matrix: List[List[int]], target: int) -> bool:
        ...
        # we now know the window where target COULD be within, perform binary search within it!
        l, r = 0 , right_edge_idx
        while l < r:
        ...
        # we now know the row where target COULD be within, perform binary search within it!
